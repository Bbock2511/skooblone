...
import { storageRef } from '../../../services/firebaseConfig'
    ...
    return (
        <SafeAreaView style={{ flex: 1, marginTop: STATUSBAR_HEIGHT }}>
            <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontSize: 16, marginTop: 10, marginLeft: 5 }}>
                    Você tem {books.length} livros na biblioteca
                </Text>
